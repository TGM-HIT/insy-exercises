...
DROP TABLE IF EXISTS movie.reviewer;

DROP TABLE IF EXISTS movie.movie_cast;
DROP TABLE IF EXISTS movie.movie_director;
DROP TABLE IF EXISTS movie.movie_genres;
...
CREATE TABLE movie.movie_cast (
  ...
  CONSTRAINT movie_cast_act_id_fkey FOREIGN KEY (act_id) REFERENCES movie.actor (act_id),
  CONSTRAINT movie_cast_mov_id_fkey FOREIGN KEY (mov_id) REFERENCES movie.movie (mov_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE movie.movie_director (
  ...
  CONSTRAINT movie_direction_dir_id_fkey FOREIGN KEY (dir_id) REFERENCES movie.director (dir_id),
  CONSTRAINT movie_direction_mov_id_fkey FOREIGN KEY (mov_id) REFERENCES movie.movie (mov_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE movie.movie_genres (
  ...
  CONSTRAINT movie_genres_gen_id_fkey FOREIGN KEY (gen_id) REFERENCES movie.genres (gen_id),
  CONSTRAINT movie_genres_mov_id_fkey FOREIGN KEY (mov_id) REFERENCES movie.movie (mov_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
