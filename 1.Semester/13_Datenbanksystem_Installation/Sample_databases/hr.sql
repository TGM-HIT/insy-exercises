...
CREATE TABLE hr.countries (
    ...
    CONSTRAINT fk_region_id_countries FOREIGN KEY (region_id) REFERENCES hr.regions (region_id) ON DELETE CASCADE ON UPDATE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE hr.locations (
    ...
    CONSTRAINT fk_country_id_locations FOREIGN KEY (country_id) REFERENCES hr.countries (country_id) ON DELETE CASCADE ON UPDATE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE hr.departments (
    ...
    CONSTRAINT fk_location_id_departments FOREIGN KEY (location_id) REFERENCES hr.locations (location_id) ON DELETE CASCADE ON UPDATE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE hr.employees (
	...
	CONSTRAINT fk_job_id_employees FOREIGN KEY (job_id) REFERENCES hr.jobs (job_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_department_id_employees FOREIGN KEY (department_id) REFERENCES hr.departments (department_id) ON DELETE CASCADE ON UPDATE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE hr.job_history (
	...
	CONSTRAINT fk_employee_id_jh FOREIGN KEY (employee_id) REFERENCES hr.employees (employee_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_job_id_jh FOREIGN KEY (job_id) REFERENCES hr.jobs (job_id) ON DELETE CASCADE ON UPDATE CASCADE ,
    CONSTRAINT fk_department_id_jh FOREIGN KEY (department_id) REFERENCES hr.departments (department_id) ON DELETE CASCADE ON UPDATE CASCADE
)  ENGINE=INNODB DEFAULT CHARSET=UTF8;
